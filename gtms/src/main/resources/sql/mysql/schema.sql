...
create table cpo_process_criteria (
	process_criteria_id bigint not null auto_increment comment '记录id',
...
create table cpo_criteria_version (
	criteria_version_id bigint not null auto_increment comment '记录id',
...
create table cpo_factory_criteria (
	factory_criteria_id bigint not null auto_increment comment '记录id',
...
create table cpo_criteria_condition (
	crit_condi_id bigint not null auto_increment comment '记录id',
	...
	criteria_value double comment '值',
	start_date datetime comment '开始时间',
	end_date datetime comment '失效时间',
	utc_create datetime comment '创建时间',
	utc_update datetime comment '修改时间',
...
create table cpo_document (
	document_id bigint not null auto_increment comment '记录id',
...
create table cpo_customer_po_record (
	customer_po_id bigint not null auto_increment comment 'customer_po',
	...
	price_per_unit double(16,2) comment 'Price Per Unit',
	...
	total_mechan_amount double(16,2) comment 'Total Mechandise Amount',
	total_tax_amount double(16,2) comment 'Total Tax Amount',
	total_adjustsment double(16,2) comment 'Total Adjustments',
	total_doc_amount double(16,2) comment 'Total Document Amount',
...
create table cpo_customer_info (
	cust_info_id bigint not null auto_increment comment '记录id',
...
create table cpo_factory_assignment (
	fact_assign_id bigint not null auto_increment comment '记录id',
	...
	gps_factory varchar(30) comment 'GPS Factory',
	pv_quantity double comment 'pv_quantity',
	assigned_factory varchar(30) comment 'Assigned Factory',
	...
	leftover double comment 'leftover',
	leftover_fty varchar(10) comment 'leftover_fty',
	pullforward double comment 'pullforward',
	...
	eu_rate double comment 'eu_rate',
	eu_quantity double comment 'eu_quantity',
	china_rate double comment 'china_rate',
	china_quantity double comment 'china_quantity',
	sum_quantity double comment 'sum_quantity',
...
create table cpo_process (
	process_id bigint not null auto_increment comment '记录id',
...
create table cpo_factory (
	factory_id bigint not null auto_increment comment '记录id',
...
create table cpo_factory_process (
	factory_process_id bigint not null auto_increment comment '记录id',
...
create table cpo_working_no (
	working_no_id bigint not null auto_increment comment '记录id',
	...
	garment_producting_day double comment 'Garment Producting Day',
	...
	smv double comment 'smv',
	mother_style varchar(255) comment 'mother style',
	inner_smv double comment 'inner smv',
	top_smv double comment 'top smv',
	bottom_smv double comment 'bottom smv',
	...
	base_fob double comment 'Base FOB',
...
create table cpo_working_no_attributes (
	work_no_attr_id bigint not null auto_increment comment '记录id',
...
create table cpo_factory_assignment_result (
	assign_result_id bigint not null auto_increment comment '记录id',
...
create table cpo_assign_score (
	assign_score_id bigint not null auto_increment comment '记录id',
...
create table cpo_admin_dict (
	dictid bigint not null auto_increment comment '序号',
...
create table cpo_marketing_forecast (
	marketing_forecast_id bigint not null auto_increment comment 'marketing_forecast',
	document_id bigint comment 'document id',
...
create table cpo_process_category (
	process_category_id bigint not null auto_increment comment '记录id',
...
create table cpo_customer_forecast (
	customer_forecast_id bigint not null auto_increment comment 'customer_forecast',
	document_id bigint comment 'document id',
	...
	china_rate double comment 'china_rate',
	china_quantity double comment 'china_quantity',
	total_quantity double comment 'total_quantity',
	utc_update datetime comment '修改时间',
	status int comment '状态',
	create_by bigint comment '创建人',
	update_by bigint comment '变更人',
...
create table cpo_edi_order_master (
	order_master_id bigint not null auto_increment comment '记录id',
	document_id bigint comment 'document id',
...
create table worktable_edi_order_size (
	edi_order_size_id bigint not null auto_increment comment '记录id',
...
create table worktable_edi_order_charge (
	edi_order_charge_id bigint not null auto_increment comment '记录id',
	order_master_id bigint comment '订单id',
...
create table worktable_edi_order_fob (
	edi_order_fob_id bigint not null auto_increment comment '记录id',
	order_master_id bigint comment '订单id',
...
create table worktable_edi_order_parties (
	edi_order_parties_id bigint not null auto_increment comment '记录id',
	order_master_id bigint comment '订单id',
...
create table factory_factory_process_loading (
	fact_pro_load_id bigint not null auto_increment comment '记录id',
	factory_id bigint comment '工厂id',
	factory_code varchar(30) comment '工厂code',
	process_id bigint comment '工序id',
	process_code varchar(30) comment 'process code',
	loading double comment 'Loading',
	capacity double comment 'Capacity',
	year int comment '年',
	month int comment '月',
	utc_update datetime comment '修改时间',
	create_by bigint comment '创建人',
...
create table cpo_factory_loading (
	factory_loading_id bigint not null auto_increment comment '记录id',
	factory_id bigint comment '工厂id',
	woven_knit varchar(20) comment 'woven/knit',
	product_type varchar(50) comment 'product Type',
	cur_doc_loading double comment 'cur_doc_loading',
	mkt_fc_loading double comment 'mkt fc loading',
	mkt_fc_cur_loading double comment 'mkt fc cur loading',
	cus_fc_cur_loading double comment 'cus fc cur loading',
	fr_mkt_fc_loading double comment 'fr_mkt_fc_loading',
	fr_cus_fc_loading double comment 'fr_cus_fc_loading',
	cus_fc_loading double comment 'cus fc loading',
	fr_loading double comment 'Fast React Loading',
	loading double comment 'Loading',
	capacity double comment 'Capacity',
	fact_load_type varchar(1) comment 'factory loading type',
	ap_group varchar(255) comment 'ap_group',
	averge_smv double comment 'averge smv',
	actual_order_loading_by_qty double comment 'actual_order_loading_by_qty',
	cf_order_loading_by_qty double comment 'cf_order_loading_by_qty',
	mf_order_loading_by_qty double comment 'mf_order_loading_by_qty',
	actual_order_cur_loading_by_qty double comment 'actual_order_cur_loading_by_qty',
	cf_order_cur_loading_by_qty double comment 'cf_order_cur_loading_by_qty',
	mf_order_cur_loading_by_qty double comment 'mf_order_cur_loading_by_qty',
	cus_fc_sub_loading double comment 'cus_fc_sub_loading',
	cus_fc_sub_loading_by_qty double comment 'cus_fc_sub_loading_by_qty',
	year int comment '年',
	month int comment '月',
	utc_update datetime comment '修改时间',
	create_by bigint comment '创建人',
...
create table cpo_factory_process_loading (
	...
	mkt_fc_cur_loading double comment 'mkt fc cur loading',
	cus_fc_cur_loading double comment 'cus fc cur loading',
	cur_loading double comment 'cur loading',
	capacity double comment 'Capacity',
	fr_order_loading double comment 'fr_order_loading',
	fr_cf_loading double comment 'fr_cf_loading',
	fr_mf_loading double comment 'fr_mf_loading',
	cus_fc_sub_loading double comment 'cus_fc_sub_loading',
	year int comment '年',
	month int comment '月',
	utc_update datetime comment '修改时间',
...
create table cpo_sms_pre_order (
	sms_pre_order_id bigint not null auto_increment comment 'sms pre order',
	document_id bigint comment 'document id',
...
create table cpo_mi_order_record (
	mi_order_id bigint not null auto_increment comment 'mi_order_id',
	document_id bigint comment 'document id',
	working_no varchar(255) comment 'Working Number',
	gps_factory varchar(30) comment 'GPS Factory',
	assigned_factory varchar(30) comment 'Assigned Factory',
...
create table cpo_factory_group (
	factory_group_id bigint not null auto_increment comment '记录id',
...
create table cpo_high_level_plan (
	high_level_plan_id bigint not null auto_increment comment '记录id',
	mo varchar(255) comment 'MO',
...
create table cpo_fr_master_data (
	fr_master_data_id bigint not null auto_increment comment '记录id',
...
create table worktable_edi_order_log (
	edi_order_log_id bigint not null auto_increment comment '记录id',
...
create table cpo_mi_forecast (
	mi_forecast_id bigint not null auto_increment comment 'mi forecast',
	document_id bigint comment 'document id',
...
create table cpo_document_log (
	document_log_id bigint not null auto_increment comment '记录id',
...
create table cpo_a_chian_buy_plan (
	a_china_buy_plan_id bigint not null auto_increment comment '记录id',
	document_id bigint comment 'document id',
	season varchar(10) comment 'Season',
	assigned_factory varchar(10) comment 'Assigned_factory',
...
create table cpo_fr_export_data_dict (
	fr_export_dict_id bigint not null auto_increment comment '记录id',
...
create table cpo_fr_low_level_plan (
	low_level_plan_id bigint not null auto_increment comment '记录id',
...
create table cpo_slt_forecast (
	slt_forecast_id bigint not null auto_increment comment 'slt_forecast',
	document_id bigint comment 'document id',
	division varchar(10) comment 'division',
	brand varchar(50) comment 'Brand',
	supply_chain_track varchar(10) comment 'Supply Chain Track',
...
create table cpo_working_no_season_attributes (
	work_no_seasonly_attr_id bigint not null auto_increment comment '记录id',
	working_no_id bigint comment 'working no id',
	working_no varchar(50) comment 'working_no',
	season varchar(10) comment 'season',
...
create table cpo_working_no_process (
	work_no_process_id bigint not null auto_increment comment '记录id',
	working_no_id bigint comment 'working no id',
	working_no varchar(50) comment 'working_no',
	...
	process_content_value double comment '工序内容值',
...
create table cpo_ax_interface_log (
	ax_interface_log_id bigint not null auto_increment comment '记录id',
...
create table cpo_slt_style (
	slt_style_id bigint not null auto_increment comment '记录ID',
	document_id bigint comment 'document id',
	working_no varchar(30) comment 'Working No',
	season varchar(10) comment 'season',
...
create table cpo_fr_interface_log (
	fr_interface_log_id bigint not null auto_increment comment '记录id',
...
create table cpo_fr_capacity (
	fr_capacity_id bigint not null auto_increment comment '记录id',
	factory varchar(10) comment 'FACTORY',
	plan_group varchar(50) comment 'PLAN GROUP',
	capacity_smv double comment 'CAPACITY(SMV)',
	actual_order_loading_smv double comment 'ACTUAL ORDER LOADING(SMV)',
	cf_loading_smv double comment 'CF LOADING(SMV)',
	mf_loading_smv double comment 'MF LOADING(SMV)',
	month varchar(10) comment 'MONTH',
	process_id varchar(10) comment 'Process id',
	process_name varchar(30) comment 'Process_name',
	weighted_avg_smv double comment 'weighted_avg_smv',
	utc_create datetime comment '创建时间',
	utc_update datetime comment '修改时间',
	high_level_plan_status varchar(1) comment '状态',
	create_by bigint comment '创建人',
...
create table cpo_working_no_product_type (
	working_no_product_type_id bigint not null auto_increment comment '记录id',
	working_no_id bigint comment 'working no id',
	working_no varchar(50) comment 'working_no',
...
create table cpo_article_development (
	cpo_article_development_id bigint not null auto_increment comment '自增id',
	article_no varchar(30) comment 'article no',
...
create table cpo_working_no_size_group (
	working_no_size_group_id bigint not null auto_increment comment '记录id',
	working_no_id bigint comment 'working no id',
	working_no varchar(50) comment 'working_no',
	season varchar(10) comment 'season',
...
create table cpo_customer_forecast_tuning (
	customer_forecast_tuning_id bigint not null auto_increment comment '记录ID',
...
create table cpo_interface_process (
	interface_process_id bigint not null auto_increment comment '记录id',
...
create table cpo_non_trade_card (
	non_trade_card_id bigint not null auto_increment comment 'non trade card order',
	document_id bigint comment 'document id',
...
create table cpo_ax_po_entity (
	ax_po_entity_id bigint not null auto_increment comment '自增ID',
...
create table cpo_working_no_pull_forward (
	working_no_pull_forward_id bigint not null auto_increment comment '记录id',
	working_no varchar(50) comment 'working_no',
	season varchar(10) comment 'season',
...
create table cpo_admin_country (
	country_id bigint not null auto_increment comment '记录ID',
...
create table cpo_factory_transfer_result (
	transfer_result_id bigint not null auto_increment comment '记录id',
	fact_assign_id bigint comment 'fact_assign_id',
	assign_result_id bigint comment 'assign_result_id',
	working_no varchar(30) comment 'Working No',
...
create table cpo_po_transfer (
	po_transfer_id bigint not null auto_increment comment '记录id',
	working_no varchar(30) comment 'working No',
...
create table cpo_style_transfer (
	style_transfer_id bigint not null auto_increment comment '记录id',
	working_no varchar(30) comment 'working No',
	...
	transfer_volume double comment 'transfer_volume',
	...
	giving_factory_fob double comment 'giving_factory_fob',
	receiving_factory_fob double comment 'receiving_factory_fob',
	diff_of_fob_data double comment 'diff_of_fob_data',
	diff_of_fob_percent double comment 'diff_of_fob_percent',
	...
	giving_factory_price_landed double comment 'Giving Factory price Landed',
	receiving_factory_price_landed double comment 'Receiving Factory price Landed',
	ei_set_up_needed varchar(10) comment 'EI set up needed',
	selling_region_percentage_eu double comment 'selling region percentage - EU',
	selling_region_percentage_asia double comment 'selling region percentage - Asia',
	selling_region_percentage_nam double comment 'selling region percentage - NAM',
	selling_region_percentage_lam double comment 'selling region percentage - LAM',
	selling_region_percentage_cis double comment 'selling region percentage - CIS',
	selling_region_percentage_china double comment 'selling region percentage - China',
	landed_price_per_selling_region_giving_factory_eu double comment 'landed price per selling region - Giving Factory - EU',
	landed_price_per_selling_region_giving_factory_asia double comment 'landed price per selling region - Giving Factory - Asia',
	landed_price_per_selling_region_giving_factory_nam double comment 'landed price per selling region - Giving Factory - NAM',
	landed_price_per_selling_region_giving_factory_lam double comment 'landed price per selling region - Giving Factory - LAM',
	landed_price_per_selling_region_giving_factory_cis double comment 'landed price per selling region - Giving Factory - CIS',
	landed_price_per_selling_region_giving_factory_china double comment 'landed price per selling region - Giving Factory - China',
...
create table cpo_vendorkpi_shipping_manual (
	vendorkpi_shipping_manual_id bigint not null auto_increment comment '记录id',
...
create table cpo_vendorkpi_shipping_order (
	vendorkpi_shipping_order_id bigint not null auto_increment comment '记录id',
	forwarder varchar(50) comment 'forwarder',
...
create table cpo_vendorkpi_shipping_invoice (
	vendorkpi_shipping_invoice_id bigint not null auto_increment comment '记录id',
	shipping_order varchar(50) comment 'shipping_order',
...
create table cpo_vendorkpi_public_holiday (
	vendorkpi_public_holiday_id bigint not null auto_increment comment '记录id',
...
create table cpo_vendorkpi_document_date (
	vendorkpi_document_date_id bigint not null auto_increment comment '记录id',
	shipping_order varchar(50) comment 'shipping_order',
	invoice_nubmer varchar(50) comment 'invoice_nubmer',
...
create table cpo_working_no_factory_smv (
	working_no_factory_smv_id bigint not null auto_increment comment '记录id',
	working_no varchar(50) comment 'working_no',
...
create table cpo_a_chian_buy_plan_size (
	a_china_buy_plan_size_id bigint not null auto_increment comment '记录id',
...
create table cpo_season_date_range_setting (
	season_date_range_setting_id bigint not null auto_increment comment '记录id',
	season varchar(10) comment 'Season',
...
create table cpo_bno_batch (
	bno_batch_id bigint not null auto_increment comment '记录id',
	b_no varchar(50) comment 'b_no',
...
create table cpo_worktable_edi_order_batch (
	worktable_edi_order_batch_id bigint not null auto_increment comment '记录id',
...
create table cpo_working_no_factory_history (
	working_no_factory_history_id bigint not null auto_increment comment '记录id',
	working_no varchar(50) comment 'working_no',
...
create table worktable_edi_order_data_history (
	edi_order_data_history_id bigint not null auto_increment comment '记录id',
	po varchar(30) comment 'po',
...
create table cpo_bno_factory_history (
	b_no_factory_history_id bigint not null auto_increment comment '记录id',
	b_no varchar(50) comment 'b_no',
	factory varchar(30) comment 'Factory',
	times int comment 'times',
...
create table cpo_mi_b_number (
	mi_b_number_id bigint not null auto_increment comment '记录id',
...
create table worktable_edi_order_change (
	order_change_id bigint not null auto_increment comment '记录id',
...
create table worktable_edi_order_approval (
	edi_order_approval_id bigint not null auto_increment comment '记录id',
	assign_result_id bigint comment 'assign_result_id',
	order_master_id bigint comment 'order_master_id',
	original_po varchar(30) comment 'original_po',
	status varchar(5) comment 'status',
...
create table worktable_edi_order_cancel (
	edi_order_cancel_id bigint not null auto_increment comment '记录id',
...
create table cpo_fr_order_schedule (
	fr_order_schedule_id bigint not null auto_increment comment '记录id',
	code varchar(100) comment 'code',
	assign_result_id bigint comment 'assign_result_id',
	to_be_status varchar(5) comment 'to_be_status',
	status varchar(5) comment 'status',
